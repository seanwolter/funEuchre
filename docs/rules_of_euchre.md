...
## funEuchre MVP Defaults

For this project, the MVP uses this exact Euchre variant:

1. Four players in two fixed partnerships, seated opposite each other.
2. A 24-card deck only (9, 10, J, Q, K, A in each suit).
3. No joker.
4. Five cards dealt to each player.
5. Two-round trump making as described below; if all players pass in round two, cards are redealt by the next dealer (no stick-the-dealer for MVP).
6. Going alone is allowed.
7. Scoring:
   - Makers take 3 or 4 tricks: 1 point
   - Makers take 5 tricks (march): 2 points
   - Lone hand takes 3 or 4 tricks: 1 point
   - Lone hand takes 5 tricks: 4 points
   - Makers are euchred: defenders score 2 points
8. Game ends at 10 points.
...
Shop Bicycle Euchre Playing Cards
